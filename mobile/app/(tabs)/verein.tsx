...
const styles = StyleSheet.create({
  sectionTitle: { fontSize: 13, fontWeight: "700", color: colors.blue, textTransform: "uppercase" },
  card: {
  ...
  contactRole: { fontSize: 13, color: colors.textMuted, marginBottom: 4 },
  ...
  sponsorName: { fontSize: 13, fontWeight: "600", color: colors.text, textAlign: "center" },
});
